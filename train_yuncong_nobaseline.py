...
stepvalues = (0, 400, 800, 1200, 1600, 13200, 18200, 25200)
gamma = 0.1
momentum = 0.9
# momentum = 0.99
...
def train():
    ...
    for iteration in range(args.start_iter, max_iter):
        ...
        if (loss.data[0] < min_loss):
            ...
            torch.save(ssd_net.state_dict(), args.save_folder + 'best_mod_Res50_pyramid' + '.pth')
        loss.backward()
        optimizer.step()
        t2 = time.time()
        ...
        if iteration % 500 == 0 or iteration in stepvalues:
            ...
            torch.save(ssd_net.state_dict(), args.save_folder + 'mod_Res50_pyramid_' +
                       repr(iteration) + '.pth')
    torch.save(ssd_net.state_dict(), args.save_folder + 'mod_Res50_pyramid' + '.pth')
