...
def train():
    ...
    for iteration in range(args.start_iter, max_iter):
        ...
        if (loss.data[0] < min_loss):
            ...
            torch.save(ssd_net.state_dict(), args.save_folder + 'best_Mall_Res50_pyramid' + '.pth')
        ...
        if iteration % 500 == 0 or iteration in stepvalues:
            ...
            torch.save(ssd_net.state_dict(), args.save_folder + 'Mall_Res50_pyramid_' +
                       repr(iteration) + '.pth')
    torch.save(ssd_net.state_dict(), args.save_folder + 'Mall_Res50_pyramid' + '.pth')
